...
def extract_from_gcs(color: str, year: int, month: int) -> Path:
    ...
    file_paths_download = gcs_block.get_directory(
        from_path=gcs_path, local_path="../data/"
    )
    print(f"file_paths_download::::::: {file_paths_download}")
    final_path = f"../data/{gcs_path}"
    print(f"PATH::::{Path(final_path)}")
